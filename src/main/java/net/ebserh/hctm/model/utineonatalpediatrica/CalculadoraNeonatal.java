...
public class CalculadoraNeonatal {
    ...
    public String toString() {
        return "CalculadoraNeonatal [nomeRecemNascido=" + nomeRecemNascido + ", nomeMae=" + nomeMae
                + ", dataNascimentoRecemNascido=" + dataNascimentoRecemNascido + ", estabilidadeRecemNascido="
                + estabilidadeRecemNascido + ", pesoAoNascer=" + pesoAoNascer + ", idadeGestacional=" + idadeGestacional
                + ", hemotransfusaoAntesPrimeiraColeta=" + hemotransfusaoAntesPrimeiraColeta
                + ", hemotransfusaoAposPrimeiraColeta=" + hemotransfusaoAposPrimeiraColeta
                + ", dataUltimaHemotransfusao=" + dataUltimaHemotransfusao + ", coletasRealizadas=" + coletasRealizadas
                + "]";
    }
}